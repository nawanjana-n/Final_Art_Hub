                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="single-input-item">
                                            ...
                                            <input type="text" id="f_name" value="{{ Auth::user()->name }}" required/>
                                        </div>
                                    </div>
                                ...
                                <div class="single-payment-method show">
                                    <div class="payment-method-name">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label" for="cashon">Credit / Debit Card Payment</label>
                                        </div>
                                    </div>
                                    <div class="payment-method-details" data-method="cash">
                                            ...
                                            <div class="single-input-item">
                                                ...
                                                <input type="number" id="c_number" placeholder="0000 0000 0000 0000" required/>
                                            </div>
